...
Das als \textit{CvCameraViewFrame} vorliegende Bild wird zur weiteren Bearbeitung in eine Matrix gespeichert. Aus performancetechnischen Gründen wird das Preprocessing in C++ ausgeführt. Dieser Schritt sorgt dafür, dass der Marker unter verschiedensten Lichtverhältnissen erkannt wird. Einer der Ansätze beinhaltete die Idee den Kontrast und die Helligkeit iterativ zu erhöhen bis der Marker gefunden wird. Aufgrund der Anzahl der Werte, die pro Frame ausprobiert werden müssen, sinkt die performance rapide. Letztendlich wurde ein Ansatz gewählt, der die Frames in ein Lichtveränderunginvariantes Format bringt (siehe Theorie 2.4).
...
>>>>>>> b5bc3ef092daf405c6fa864d35e45898f728fc93
%-----------------------------------------------------------------------------
%-----------------------------------------------------------------------------
...
Im Folgenden sind die Ergebnisse der resultierenden Applikation aufgezeigt. 
	...
	Die Framerate liegt im Schnitt bei 13 FPS und es ist noch leichtes ruckeln zu vermerken. Dies kann jedoch mit leistungsfähigeren Geräten verhindert werden.
	Im folgenden die wichtigsten Werte der Applikation und der Hardware des verwendeten Smartphonesq:
