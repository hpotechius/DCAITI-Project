...
Der größte Teil der verbrauchten Rechenleistung wird dem Preprocessing und dem Objekt rendering zugeschrieben. Entsprechend können an dieser Stelle noch Optimierungen vorgenommen werden, um eine flüssigere Objektdarstellung zu ermöglichen.
